...
//                                scoreValue = "In process...";
//                            }
//                            if (image_pathValue.isEmpty()) {
//                                image_pathValue = "https://cdn2.iconfinder.com/data/icons/male-users-2/512/2-512.png";
//                            }
//                            currentStudentClass = new Student(scoreValue, usernameValue, image_pathValue);
//                        }else {
//                            scoreValue = student.getValue(Student.class).getScore();
//                            if (scoreValue.trim().isEmpty()) {
//                                scoreValue = "In process...";
...
//                            }
//                            usernameValue = student.getValue(Student.class).getUsername();
//                            Student new_student = new Student(scoreValue, usernameValue, image_pathValue);
...
//                rateInSchool.setText(Integer.toString(students.indexOf(currentStudentClass)+1));
//            }
//
//            @Override
//            public void onCancelled(DatabaseError databaseError) {
...
//        students.clear();
//        mDatabaseRef.child(foundGroup).addValueEventListener(new ValueEventListener() {
//            @Override
//            public void onDataChange(DataSnapshot dataSnapshot) {
//                for(DataSnapshot currentGroupMembers : dataSnapshot.getChildren()){
//                    if(currentGroupMembers.getKey().equals(user.getEmail().replace(".", ""))){
//                        scoreValue = currentGroupMembers.getValue(Student.class).getScore();
//                        image_pathValue = currentGroupMembers.getValue(Student.class).getImage_path();
//                        usernameValue = currentGroupMembers.getValue(Student.class).getUsername();
//                        if (image_pathValue.isEmpty()) {
//                            image_pathValue = "https://cdn2.iconfinder.com/data/icons/male-users-2/512/2-512.png";
//                        }
//                        currentStudentClass = new Student(scoreValue, usernameValue, image_pathValue);
...
//                        }
//                        usernameValue = currentGroupMembers.getValue(Student.class).getUsername();
//                        Student student = new Student(scoreValue, usernameValue, image_pathValue);
