...
/**
 * Фрагмент со отклоненными запросами на регистрацию
 */
...
public class DeniedRegisterRequests extends Fragment {
    ...
    /**
     * Получить отклоненными запросы учителя на регистрацию ученика
     */

    private void getRegistrationRequests(){
        Teacher.getDeniedRegistrationRequests(mGetRegistrationRequestsCallback, teacherID);
    }
